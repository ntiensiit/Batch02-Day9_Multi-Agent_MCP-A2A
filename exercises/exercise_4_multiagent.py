...
def routing_logic(state: State) -> list[Send]:
...
def build_graph() -> StateGraph:
    ...
    graph.add_conditional_edges("law_agent", routing_logic)
...
async def main():
    ...
    question = "What are the legal and tax consequences if a company leaks customer data?"
